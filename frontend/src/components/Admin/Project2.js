...
import SectionProject2 from '../Projects/SectionProject2';
...
const Project2 = () => {
  ...
  useEffect(() => {
    ...
    if (projects && projects.length !== 0 && projects[1]) {
      setId(projects[1].projectId);
      setName(projects[1].name);
      setSummary(projects[1].summary);
      setDetails(projects[1].details);
      // setDetails('');
    }
