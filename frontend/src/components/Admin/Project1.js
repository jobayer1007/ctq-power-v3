...
import SectionProject1 from '../Projects/SectionProject1';
...
const Project1 = () => {
  ...
  useEffect(() => {
    if (!projects || projects.length === 0) {
      ...
      setId(projects[0].projectId);
      setName(projects[0].name);
      setSummary(projects[0].summary);
      setDetails(projects[0].details);
    }
  ...
  return (
    <main>
      <div className='d-flex align-items-center justify-content-center main-content mb-3'>
        ...
        <Card border='info'>
          <Card.Header className='text-center' as='h2'>
            Welcom To the Project: Section 1
          </Card.Header>
          <Card.Body>
      ...
      {projectAllLoading ? (
        ...
        projects &&
        projects.length !== 0 && <SectionProject1 project={projects[0]} />
      )}
    </main>
  );
};
